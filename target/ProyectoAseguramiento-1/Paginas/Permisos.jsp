...
<html>
    ...
    <body>
        ...
        <div class="container" style="">
            ...
            <form id="form-work" class="" name="form-work" action="/ProyectoAseguramiento/ControllerPermisos" method="get">
            ...
            <tbody>
                <tr>
                    <td class="text-center">                                
                        <a href="/ProyectoAseguramiento/ControllerPermisos?accion=delete&id=<%= perm.getId_Permiso()%>">Eliminar</a>
                    </td>
