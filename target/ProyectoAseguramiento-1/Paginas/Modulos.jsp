...
<html>
    <head>
        ...
        <center>
            <h1>Modulos</h1>
            <a class="btn btn-success" href="/ProyectoAseguramiento/ControllerModulos?accion=add&id=0"  > Agregar modulo </a>
            <br>
            <br>
        </center>
        <div class="container">            
            ...
            <tbody>
                <tr>
                    <td class="text-center">                                
                        <a href="/ProyectoAseguramiento/ControllerModulos?accion=editar&id=<%= mod.getId_modulo()%>">Editar</a>
                        <a href="/ProyectoAseguramiento/ControllerModulos?accion=delete&id=<%= mod.getId_modulo()%>">Eliminar</a>
                    </td>
