                ...
                <div class="container">
                    <form id="form-work" class="" name="form-work" action="ControllerRoles" method="get">
                        ...
                        <div class="col-md-4">
                            ...
                            <input name="nombre" class="form-control" placeholder="Nombre" type="text" value ="<%= rol.getNombre()%>" readonly>
                        </div>
                        <br><br><br><br>
                        <div class="col-md-4">
                            <label class="control-label" for="apellido">Descripción</label>
                            <input name="descripcion" class="form-control" placeholder="Descripción" type="text" value ="<%= rol.getDescripcion()%>" readonly>
                        </div>
                        <br><br><br><br>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input name="fecha" class="form-control" placeholder="Fecha (dd/mm/aaaa)" type="text" value="<%= rol.getFecha_crea()%>" readonly>
                        </div>
                        <br><br><br><br>
                        <div class="col-md-3">
                            <button type="submit" name="accion" value="remove" class="btn btn-danger btn-lg btn-block info">Eliminar</button>
                            <br>
