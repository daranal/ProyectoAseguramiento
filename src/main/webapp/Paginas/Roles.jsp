...
<html>
    <head>
        ...
        <center>
            <h1>Roles</h1>
            <a class="btn btn-success" href="/ProyectoFaseI/ControllerRoles?accion=add"  > Añadir rol </a>
            <br><br>
        </center>
        <div class="container">            
            ...
            <tbody>
                <tr>
                    <td class="text-center">                                
                        <a href="/ProyectoFaseI/ControllerRoles?accion=editar&id=<%= rol.getIdRol()%>">Editar</a>
                        <a href="/ProyectoFaseI/ControllerRoles?accion=delete&id=<%= rol.getIdRol()%>">Eliminar</a>
                    </td>
